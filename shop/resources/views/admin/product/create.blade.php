    ...
    <div class="col-12">
        <form method="post">
            ...
            <div class="form-group {{$errors->has('category_id')?' has-danger':''}} ">
                ...
                <input type="text" name="category_id" value="{{old('category_id')}}" class="form-control{{$errors->has('category_id')?' form-control-danger':''}} " id="category" aria-describedby="emailHelp" placeholder="name">
            ...
            <div class="form-group {{$errors->has('name')?' has-danger':''}} ">
                ...
                <input type="text" name="name" value="{{old('name')}}" class="form-control{{$errors->has('name')?' form-control-danger':''}} " id="name" aria-describedby="nameHelp" placeholder="name">
                @if($errors->has('name'))
